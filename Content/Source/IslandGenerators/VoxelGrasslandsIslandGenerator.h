...
#include "VoxelGrasslandsIslandGenerator.generated.h"

/**
 * 
 */
UCLASS()
class SURVIVALFPS_API UVoxelGrasslandsIslandGenerator : public UVoxelIslandGenerator
{
	GENERATED_BODY()
...
class FVoxelGrasslandsIslandGeneratorInstance : public TVoxelGeneratorInstanceHelper<FVoxelGrasslandsIslandGeneratorInstance, UVoxelGrasslandsIslandGenerator>
{
public:
	using Super = TVoxelGeneratorInstanceHelper<FVoxelGrasslandsIslandGeneratorInstance, UVoxelGrasslandsIslandGenerator>;
...
public:
	explicit FVoxelGrasslandsIslandGeneratorInstance(const UVoxelGrasslandsIslandGenerator& MyGenerator);
