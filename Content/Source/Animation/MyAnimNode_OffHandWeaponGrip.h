...
#include "MyAnimNode_OffHandWeaponGrip.generated.h"

/**
 * 
 */
USTRUCT(BlueprintInternalUseOnly)
struct SURVIVALFPS_API FMyAnimNode_OffHandWeaponGrip : public FAnimNode_SkeletalControlBase
{
	GENERATED_BODY()
